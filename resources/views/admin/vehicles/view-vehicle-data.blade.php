    ...
    <div class="mx-44">
        <div class="flex items-center justify-between mt-5 mb-5">
            ...
            <a href="{{ route('vehicles.create') }}"
                class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Tambah
                Data Kendaraan</a>
        </div>
                ...
                <tbody>
                    @foreach ($vehicles as $vehicle)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ asset('storage/' . $vehicle->vehicle_image) }}" width="100"
                                    alt="">
                            </td>
