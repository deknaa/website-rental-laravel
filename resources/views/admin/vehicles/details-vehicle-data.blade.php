            ...
            <div class="grid grid-cols-2 gap-2">
                <div class="">
                    ...
                    <input type="text" name="vehicle_name" id="vehicle_name"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" placeholder="Nama Kendaraan.."
                ...
                <div class="">
                    ...
                    <select name="petrol" id="petrol"
                        class="w-full p-2 border border-gray-600 rounded-lg" disabled>
                ...
                <div class="">
                    ...
                    <input type="text" name="plate" id="plate"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" value="{{ old('plate', $vehicle->plate) }}" placeholder="Nama Kendaraan.." disabled>
                </div>
                <div class="">
                    <label for="vehicle_color">Warna Kendaraan</label><br>
                    <input type="text" name="vehicle_color" id="vehicle_color"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" value="{{ old('vehicle_color', $vehicle->vehicle_color) }}" placeholder="Nama Kendaraan.." disabled>
                </div>
                <div class="">
                ...
                <div class="">
                    ...
                    <input type="number" name="vehicle_seat" id="vehicle_seat"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" value="{{ old('vehicle_seat', $vehicle->vehicle_seat) }}" placeholder="Jumlah Kursi Kendaraan.." disabled>
                </div>
                <div class="">
                    <label for="vehicle_price">Harga Sewa Kendaraan</label><br>
                    <input type="number" name="vehicle_price" id="vehicle_price"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" value="{{ old('vehicle_price', $vehicle->vehicle_price) }}" placeholder="Harga Sewa Kendaraan.." disabled>
                </div>
                <div class="">
                    <label for="vehicle_year">Tahun Kendaraan</label><br>
                    <input type="date" name="vehicle_year" id="vehicle_year"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" value="{{ old('vehicle_year', $vehicle->vehicle_year) }}" disabled>
                </div>
                <div class="">
                    <label for="vehicle_engine">Mesin Kendaraan</label><br>
                    <input type="text" name="vehicle_engine" id="vehicle_engine"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" value="{{ old('vehicle_engine', $vehicle->vehicle_engine) }}" placeholder="CC Mesin Kendaraan.." disabled>
                </div>
                <div class="">
                    <label for="vehicle_doors">Jumlah Pintu Kendaraan</label><br>
                    <input type="text" name="vehicle_doors" id="vehicle_doors"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" value="{{ old('vehicle_doors', $vehicle->vehicle_doors) }}" placeholder="Jumlah Pintu Kendaraan.." disabled>
                </div>
                <div class="">
                ...
                <div class="">
                    ...
                    <input type="text" name="vehicle_merk" id="vehicle_merk"
                        class="w-full p-2 border-2 border-gray-600 rounded-lg" value="{{ old('vehicle_merk', $vehicle->vehicle_merk) }}" placeholder="Merk Kendaraan.." disabled>
                </div>
                <div class="">
